...
function normalizeObject<T extends Record<string, unknown>>(
  ...
  if (
    record.overview &&
    typeof record.overview === "object" &&
    !Array.isArray(record.overview)
  ) {
    ...
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Budget transparency, contractor accountability, and corruption
          detection
        </p>
      </div>
        ...
        <ResponsiveContainer width="100%" height={250}>
          <LineChart data={ov.yearlyTrend}>
            ...
            <YAxis
              ...
              tick={{ fontSize: 11 }}
              tickFormatter={(value) =>
                `₹${(safeNumber(value) / 10000000).toFixed(0)}Cr`
              }
            />
